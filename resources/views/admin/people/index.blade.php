                        ...
                        <table class="w-full mt-4">
                            <thead class="text-black">
                                <tr>
                                    ...
                                    <th class="p-4 bg-gray-200">Total Services</th>
                                    <th class="p-4 bg-gray-200">Phone number</th>
                            ...
                            <tbody>
                                @forelse ($people as $person)
                                    {{-- @dump($person) --}}
                                    <tr>
                                        <td class="w-16 p-4 border">{{ $person->id }}</td>
                                        <td class="p-4 border">{{ $person->name }}</td>
                                        <td class="p-4 border">{{ $person->location->name }}</td>
                                        <td class="p-4 border">{{ $person->role }}</td>
                                        <td class="p-4 border">{{ $person->services->count() }}</td>
                                        <td class="p-4 border">{{ $person->phone_number }}</td>
